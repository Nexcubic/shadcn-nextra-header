  ...
  return (
    <section className="py-16 lg:py-24">
      ...
      <div className="w-full">
        ...
        >
          <CarouselContent className="ml-4 lg:ml-[max(2rem,calc(50vw-600px))] 2xl:mr-[max(0rem,calc(50vw-700px))]">
            {items.map((item) => (
              <CarouselItem
                key={item.id}
                ...
                <a href={item.href} className="group rounded-xl">
                  <div className="group relative h-full min-h-[24rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9]">
                    ...
                    <div className="absolute inset-x-0 bottom-0 flex flex-col items-start p-6 text-primary-foreground md:p-8">
                      ...
                      <div className="mb-8 line-clamp-2 text-primary-foreground/90 md:mb-12 lg:mb-9">
                        {item.description}
                      </div>
